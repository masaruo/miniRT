...
t_light	*_get_a_light(char **lines)
{
	...
	light->vector = vec3_default_ranged_str_init(lines[1]);
...
t_shape	*_get_a_sphere(char **lines)
{
	...
	sphere->u_obj.sphere.center = vec3_default_ranged_str_init(lines[1]);
...
t_shape	*_get_a_plain(char **lines)
{
	...
	plane->u_obj.plane.position = vec3_default_ranged_str_init(lines[1]);
...
t_shape	*_get_a_cylinder(char **lines)
{
	...
	cylinder->u_obj.cylinder.position = vec3_default_ranged_str_init(lines[1]);
