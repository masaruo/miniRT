...
/*   Updated: 2024/02/20 16:12:42 by mogawa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// t_vec3	_rotate_y(t_vec3 const *vec, double cosA, double sinA)//DEL
// {
// 	t_vec3			rotated;
...
// //!マイナス回転
// t_vec3	_rotate_z(t_vec3 const *vec, double cosG, double sinG)//DEL
// {
// 	t_vec3			rotated;
...
// 	t = (screen_width / 2) * (1 / tan(convert_degree_to_radian(fov/2));
